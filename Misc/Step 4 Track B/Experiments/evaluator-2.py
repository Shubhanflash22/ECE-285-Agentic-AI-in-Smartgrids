...
BASE_PATH = "/data/SolarAgent"

MANIFEST_OP1  = f"{BASE_PATH}/output_1/grid_manifest_op1.csv"
MANIFEST_OP2  = f"{BASE_PATH}/output_2/grid_manifest_op2.csv"
OUTPUT_DIR_1  = f"{BASE_PATH}/output_1"
OUTPUT_DIR_2  = f"{BASE_PATH}/output_2"
...
OUTPUT_XLSX   = f"{BASE_PATH}/baseline_comparison-1.xlsx"
SUMMARY_XLSX  = f"{BASE_PATH}/summary_comparison-1.xlsx"
...
def main():
    ...
    print(f"  Solver: Native HiGHS via highspy")
    print()
